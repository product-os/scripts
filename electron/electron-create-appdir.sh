...
function usage() {
  ...
  echo "Options" 1>&2
  echo "" 1>&2
  echo "    -n <application name>" 1>&2
  echo "    -d <application description>" 1>&2
  echo "    -p <application package>" 1>&2
  echo "    -r <application architecture>" 1>&2
  echo "    -b <application binary name>" 1>&2
  echo "    -i <application icon (.png)>" 1>&2
  echo "    -o <output>" 1>&2
  exit 1
}
